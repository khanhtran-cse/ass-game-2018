...
def getDestinationPost(myTank, enemy, shot,speed):
    # print('automove')
    center = myTank.rect.center

    for index,spr in enumerate(shot):
        pos = spr.getPos()
        xx = pos[0] - center[0]
        yy = pos[1] - center[1]
        ...
        if(x + pos[0] >= center[0] -80 and x + pos[0] <= center[0] + 80 \
            and y+pos[1] >= center[1] - 80 and y + pos[1] <= center[1] + 80):
